 ...
 <div class="col-8">
  <form  action="{{ url('cms/products') }}" method="POST" novalidate="novalidate" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="form-group">
       ...
       <input value="{{ old('p_title') }}" type="text" name="p_title" id="p_title" class="form-control field-input-cms original-text">
    ...
    <div class="form-group">
       ...
       <input value="{{ old('p_url') }}" type="text" name="p_url" id="url" class="form-control field-input-cms target-text">
    ...
    <input class="btn btn-dark " type="submit" name="submit" value="Save Product">
  </form>
 </div>
</div>
